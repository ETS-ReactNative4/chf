...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("axios");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var ramda__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("ramda");
...
/* harmony import */ var _components_Vendors_VendorEdit__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("../client/src/modules/admin/components/Vendors/VendorEdit.jsx");
...
var Vendor = function (_Component) {
  ...
  function Vendor(props) {
    ...
    var _this = babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_5___default()(this, (Vendor.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_2___default()(Vendor)).call(this, props));
    ...
    _this.uploadToS3 = function () {
      var _ref = babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(signedRequest, file) {
        var options;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_9___default.a.put(signedRequest, file, options);
    ...
    _this.adaptFileEventToValue = function (delegate) {
      return function () {
        var _ref2 = babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(e) {
              ...
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  getFileNameAndType = function getFileNameAndType(file) {
                    return Object(ramda__WEBPACK_IMPORTED_MODULE_10__["pick"])(['name', 'type'], file);
                  };

                  response = function () {
                    var _ref3 = babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(signS3, _ref4) {
                      var name = _ref4.name,
                          type = _ref4.type;
                  ...
                  if (files.length !== 0 && typeof files !== 'undefined') {
                    ...
                    Object(ramda__WEBPACK_IMPORTED_MODULE_10__["forEach"])(function () {
                      var _ref5 = babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(file) {
                    ...
                    }(), Object(ramda__WEBPACK_IMPORTED_MODULE_10__["values"])(files));
                  }
  ...
  babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(Vendor, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (vendor) {
        if (!prevState.image) {
          this.setState({ image: vendor.image_url });
        }
      }
    ...
    value: function render() {
      ...
      if (!vendor) {
        return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(
          ...
          this.props,
          react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_common_components_global_components_Loader__WEBPACK_IMPORTED_MODULE_12__["default"], null)
        );
      }
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(
        _components_AdminView__WEBPACK_IMPORTED_MODULE_11__["default"],
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_apollo__WEBPACK_IMPORTED_MODULE_8__["compose"])(react_apollo__WEBPACK_IMPORTED_MODULE_8__["withApollo"], Object(react_apollo__WEBPACK_IMPORTED_MODULE_8__["graphql"])(_graphql_S3Upload_graphql__WEBPACK_IMPORTED_MODULE_13___default.a, {
  props: function props(_ref6) {
    var mutate = _ref6.mutate;
    return {
      signS3: function () {
        var _ref7 = babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee5(filename, filetype) {
          var response;
...
//# sourceMappingURL=index.bf982517aa9656768337.js.map