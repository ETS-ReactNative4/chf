          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                config = products.reduce(function (accum, _ref5) {
                  var node = _ref5.node;

                  // console.log('CURR::', node);
                  accum = [].concat(babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(accum), [{ vendor_name: pathFormater(node.vendor) }]);
                  return accum;
                });
...
//# sourceMappingURL=index.32a95957918d3c66fc53.js.map