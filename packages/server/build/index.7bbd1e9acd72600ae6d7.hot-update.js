      ...
      var loadMore = function loadMore() {
        ...
        return fetchMore({
          ...
          updateQuery: function updateQuery(prevResult, _ref3) {
            ...
            if (fetchMoreResult.admin_products.admin_products.edges.length === 0) return prevResult;
            // const updatedResult = JSON.parse(JSON.stringify(prevResult));
            var updatedResult = {};
            updatedResult.admin_products.edges = [].concat(babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(prevResult.admin_products.admin_products.edges), babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(fetchMoreResult.admin_products.admin_products.edges));
            updatedResult.pageInfo = fetchMoreResult.admin_products.admin_products.pageInfo;
...
//# sourceMappingURL=index.a384f06ab303829ad1f6.js.map