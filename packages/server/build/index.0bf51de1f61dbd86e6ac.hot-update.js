  ...
  function SiteMapGenerator(props) {
    ...
    _this.generateProductsConfig = function () {
      var _ref4 = babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default()( /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee4(products) {
        var path, pathFormater, configReducer, singleProductConfig, vendorConfig, config;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                singleProductConfig = products.reduce(function (accum, _ref6) {
                  var node = _ref6.node;
                ...
                vendorConfig = function () {
                  var _ref7 = babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default()( /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee3(data) {
                    var config;
                          ...
                          case 0:
                            ...
                            return configReducer(data, function (node, accum) {
                              ...
                              if (accum.length >= 0) {
                                ...
                                accum.map(function (_ref8) {
                                  var vendor_name = _ref8.vendor_name;
                                  ...
                                  if (config.length == 0) {
                                    ...
                                    config.map(function (config) {
                                      if (config.vendor_name == vendor_name) {
                                        ...
                                        config = [].concat(babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(config), [vendor]);
                                      }
                                    });
                                  }
                                });
                ...
                console.log('VENDOR CONFIG::', vendorConfig(products));
                config = {
...
//# sourceMappingURL=index.4e5635d7a98c6da02830.js.map