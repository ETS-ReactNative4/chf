...
/* harmony import */ var babel_runtime_helpers_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("babel-runtime/helpers/taggedTemplateLiteral");
...
/* harmony import */ var _LocationsView__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("../client/src/modules/admin/components/Locations/LocationsView.jsx");
...
var Locations = function (_Component) {
  babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_8___default()(Locations, _Component);

  function Locations(props) {
    babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_5___default()(this, Locations);

    var _this = babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_7___default()(this, (Locations.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_4___default()(Locations)).call(this, props));

    _this.state = {};
    return _this;
  }

  babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_6___default()(Locations, [{
    key: 'render',
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(_LocationsView__WEBPACK_IMPORTED_MODULE_16__["default"], this.props);
    }
  }]);
...
var LocationsWithApollo = Object(react_apollo__WEBPACK_IMPORTED_MODULE_10__["compose"])(Object(react_apollo__WEBPACK_IMPORTED_MODULE_10__["graphql"])(_graphql_DealerQuery_graphql__WEBPACK_IMPORTED_MODULE_14___default.a, {
...
}), Object(react_apollo__WEBPACK_IMPORTED_MODULE_10__["graphql"])(_graphql_SimplePageQuery_graphql__WEBPACK_IMPORTED_MODULE_12___default.a, {
  ...
  props: function props(_ref4) {
    ...
    return {
      updateDealer: function () {
        var _ref5 = babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default()( /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(dealer) {
          var _ref6, data;
                  ...
                  return mutate({
                    ...
                    update: function update(proxy, _ref7) {
                      ...
                      var data = proxy.readQuery({
                        query: graphql_tag__WEBPACK_IMPORTED_MODULE_11___default()(_templateObject),
                        variables: { handle: ' ' }
                      });
                      console.log('DEALERS QUERY::', _graphql_Dealers_graphql__WEBPACK_IMPORTED_MODULE_13___default.a);
                      var test = proxy.readQuery({ query: graphql_tag__WEBPACK_IMPORTED_MODULE_11___default()(_templateObject2),
                        variables: { first: 12 }
                      });
...
//# sourceMappingURL=index.6419d3fb70e141ef8972.js.map