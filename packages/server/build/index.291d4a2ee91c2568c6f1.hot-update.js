              ...
              case 0:
                ...
                configReducer = function configReducer(data, config) {
                  return data.reduce(function (accum, _ref5) {
                    ...
                    var _accum = config(node, accum);
                    accum = [].concat(babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(accum), [_accum]);
                    return accum;
                  }, []);
                };
                ...
                vendorConfig = function () {
                  var _ref6 = babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default()( /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee3(data, reducer) {
                    var config;
                      ...
                      while (1) {
                        switch (_context3.prev = _context3.next) {
                          case 0:
                            config = [];
                            _context3.next = 3;
                            return reducer(data, function (node, accum) {
                              var vendor = {
                  ...
                  return function vendorConfig(_x2, _x3) {
                    return _ref6.apply(this, arguments);
                  };
                }();

                _context4.next = 6;
                return vendorConfig(products, configReducer);
...
//# sourceMappingURL=index.f1216836b5a23ecc0b20.js.map