                        ...
                        switch (_context3.prev = _context3.next) {
                          case 0:
                            ...
                            data.forEach(function (_ref7) {
                              ...
                              if (config.length == 0) {
                                config.push({ vendor_name: pathFormater(node.vendor) });
                              } else {
                                // console.log('CONFIG::', config);
                                config.map(function (_ref8) {
                                  var vendor_name = _ref8.vendor_name;

                                  console.log('VENDOR NAME:', vendor_name, 'NODE::', pathFormater(node.vendor), node);
                                  if (vendor_name !== pathFormater(node.vendor)) {
                                    return { vendor_name: pathFormater(node.vendor) };
                                  } else {
                                    return;
                                  }
                                });
...
//# sourceMappingURL=index.29fe2eac5b790d1cdcc1.js.map