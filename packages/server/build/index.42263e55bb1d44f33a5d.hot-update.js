              ...
              case 0:
                ...
                configReducer = function configReducer(data, config) {
                  return data.reduce(function (accum, _ref5) {
                    ...
                    accum = [].concat(babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(accum), [config(node)]);
                    return accum;
                  }, []);
                };
                ...
                vendorConfig = configReducer(products, function (node) {
                  return {
...
//# sourceMappingURL=index.d4ba1f7a7d6802beb238.js.map