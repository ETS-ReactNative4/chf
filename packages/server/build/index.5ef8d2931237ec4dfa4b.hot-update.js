...
/* harmony import */ var babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("babel-runtime/helpers/defineProperty");
/* harmony import */ var babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("babel-runtime/helpers/extends");
...
/* harmony import */ var babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("babel-runtime/helpers/toConsumableArray");
/* harmony import */ var babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("prop-types");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var react_apollo__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("react-apollo");
...
/* harmony import */ var react_icons_md__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__("react-icons/md");
...
/* harmony import */ var _styles_manage_specs_scss__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__("../client/src/modules/profile/styles/manage-specs.scss");
/* harmony import */ var _styles_manage_specs_scss__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(_styles_manage_specs_scss__WEBPACK_IMPORTED_MODULE_18__);
/* harmony import */ var _common_graphql_ProductDataQuery_graphql__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__("../client/src/modules/common/graphql/ProductDataQuery.graphql");
/* harmony import */ var _common_graphql_ProductDataQuery_graphql__WEBPACK_IMPORTED_MODULE_19___default = /*#__PURE__*/__webpack_require__.n(_common_graphql_ProductDataQuery_graphql__WEBPACK_IMPORTED_MODULE_19__);
/* harmony import */ var _common_graphql_AddProductData_graphql__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__("../client/src/modules/common/graphql/AddProductData.graphql");
/* harmony import */ var _common_graphql_AddProductData_graphql__WEBPACK_IMPORTED_MODULE_20___default = /*#__PURE__*/__webpack_require__.n(_common_graphql_AddProductData_graphql__WEBPACK_IMPORTED_MODULE_20__);
/* harmony import */ var _common_graphql_UpdateProductData_graphql__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__("../client/src/modules/common/graphql/UpdateProductData.graphql");
/* harmony import */ var _common_graphql_UpdateProductData_graphql__WEBPACK_IMPORTED_MODULE_21___default = /*#__PURE__*/__webpack_require__.n(_common_graphql_UpdateProductData_graphql__WEBPACK_IMPORTED_MODULE_21__);
/* harmony import */ var _common_schema__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__("../client/src/modules/common/schema/index.js");
/* harmony import */ var _products_components_SingleProductView__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__("../client/src/modules/products/components/SingleProductView.web.jsx");
...
var fullSpecs = [].concat(babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_13___default()(_products_components_SingleProductView__WEBPACK_IMPORTED_MODULE_23__["prodSpecs"]), babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_13___default()(_products_components_SingleProductView__WEBPACK_IMPORTED_MODULE_23__["prodFeatures"]));
var clearedSubmissionResult = { submissionError: null, submissionSuccess: null };

var ManageSpecs = function (_React$Component) {
  babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_12___default()(ManageSpecs, _React$Component);
  ...
  function ManageSpecs() {
    ...
    babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_9___default()(this, ManageSpecs);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_11___default()(this, (_ref = ManageSpecs.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_8___default()(ManageSpecs)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      currentEdit: {},
      ...
      return _this.setState(babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_7___default()({
      ...
      _this.setState({ currentEdit: babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_7___default()({}, prevEdit, babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()({}, name, value)) });
    }, _this.submitSpecs = function () {
      var _ref2 = babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_5___default()( /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee(e) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _Object$assign = babel_runtime_core_js_object_assign__WEBPACK_IMPORTED_MODULE_3___default()(currentSpecs, currentEdit, {
                  handle: selectedProduct
                }), __typename = _Object$assign.__typename, id = _Object$assign.id, specsToSubmit = babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_4___default()(_Object$assign, ['__typename', 'id']);
                ...
                }), _products$edges$filte2 = babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2___default()(_products$edges$filte, 1), sfyData = _products$edges$filte2[0];
                ...
                updatedSubmission = babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_7___default()({}, specsToSubmit, { product_name: vendor + ' ' + title, sku: _sku });
                _context.next = 13;
      ...
      if (selectedSpec in currentEdit) {
        var removed = currentEdit[selectedSpec],
            rest = babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_4___default()(currentEdit, [selectedSpec]);
  ...
  babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_10___default()(ManageSpecs, [{
    ...
    value: function render() {
      ...
      console.log('PRODUCTS LOADING::', this.props);
      var products = null;
      ...
      return react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
        ...
        react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
          ...
          react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
            ...
            'Please select a product to change product specifications'
          ),
          react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
            'select',
            { id: 'product-select', onChange: this.handleProductSelect, value: selectedProduct },
            react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
              'option',
              { value: selectProdString, disabled: true },
              selectProdString
            ),
            products ? products.map(function (_ref4) {
              var node = _ref4.node;
              return react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
                'option',
        ...
        selectedProduct !== selectProdString ? react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
          'form',
          ...
          react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
            ...
            react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
              ...
              fullSpecs.map(function (_ref5, i) {
                var _ref6 = babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2___default()(_ref5, 2),
                    key = _ref6[0],
                    value = _ref6[1];
          ...
          selectedSpec !== selectSpecString ? react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
            'div',
          ...
          react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
            ...
            this.state.currentEdit.hasOwnProperty(this.state.selectedSpec) ? react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
              'button',
              { type: 'button', onClick: function onClick() {
                  return handleCancelEdit();
                } },
              react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(react_icons_md__WEBPACK_IMPORTED_MODULE_17__["MdClose"], { className: 'manage-specs-form__icon' }),
              react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
                'span',
                null,
                'Cancel Edit'
            ...
            react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
              ...
              react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(react_icons_md__WEBPACK_IMPORTED_MODULE_17__["MdSave"], { className: 'manage-specs-form__icon' }),
              react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
                'span',
                null,
        ...
        ['submissionSuccess', 'submissionError'].map(function (property) {
          if (property in _this3.state) return react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(
            'div',
            { key: property },
...
var ManageSpecsWithApollo = Object(react_apollo__WEBPACK_IMPORTED_MODULE_16__["compose"])(Object(_common_schema__WEBPACK_IMPORTED_MODULE_22__["ADMIN_PRODUCTS_QUERY"])(), Object(react_apollo__WEBPACK_IMPORTED_MODULE_16__["graphql"])(_common_graphql_ProductDataQuery_graphql__WEBPACK_IMPORTED_MODULE_19___default.a, {
...
}), Object(_common_schema__WEBPACK_IMPORTED_MODULE_22__["MODIFY_PRODUCT_DATA"])(_common_graphql_AddProductData_graphql__WEBPACK_IMPORTED_MODULE_20___default.a, 'addProductData'), Object(_common_schema__WEBPACK_IMPORTED_MODULE_22__["MODIFY_PRODUCT_DATA"])(_common_graphql_UpdateProductData_graphql__WEBPACK_IMPORTED_MODULE_21___default.a, 'updateProductData'))(ManageSpecs);

ManageSpecs.propTypes = {
  productsLoading: prop_types__WEBPACK_IMPORTED_MODULE_15___default.a.bool,
  products: prop_types__WEBPACK_IMPORTED_MODULE_15___default.a.array,
  productSpecs: prop_types__WEBPACK_IMPORTED_MODULE_15___default.a.array,
  refetchProductData: prop_types__WEBPACK_IMPORTED_MODULE_15___default.a.func,
  sfy_shop: prop_types__WEBPACK_IMPORTED_MODULE_15___default.a.object,
  productData: prop_types__WEBPACK_IMPORTED_MODULE_15___default.a.object,
  loadingProductData: prop_types__WEBPACK_IMPORTED_MODULE_15___default.a.bool
};
...
//# sourceMappingURL=index.f94f8dca3090f3916084.js.map