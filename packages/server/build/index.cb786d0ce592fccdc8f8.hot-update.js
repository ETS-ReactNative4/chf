...
var AdminWithApollo = Object(react_apollo__WEBPACK_IMPORTED_MODULE_10__["compose"])(Object(react_apollo__WEBPACK_IMPORTED_MODULE_10__["graphql"])(_graphql_PagesQuery_graphql__WEBPACK_IMPORTED_MODULE_12___default.a, {
  ...
  options: {
    refetchQueries: function refetchQueries(_ref12) {
      var updateDealer = _ref12.data.updateDealer;

      console.log('RESULT', updateDealer);
      return [{ query: _graphql_Dealers_graphql__WEBPACK_IMPORTED_MODULE_15___default.a, variables: { first: 12, after: 0 } }, { query: _graphql_DealerQuery_graphql__WEBPACK_IMPORTED_MODULE_16___default.a, variables: { handle: updateDealer.handle } }];
    }
  }
}))(Admin);
...
//# sourceMappingURL=index.5e6a122d1ce4a1099a82.js.map