  ...
  options: {
    update: function update(proxy, _ref12) {
      ...
      try {
        ...
        var data = proxy.readQuery({ query: _graphql_Dealers_graphql__WEBPACK_IMPORTED_MODULE_15___default.a, variables: { first: 12, after: 0 } });
        ...
        proxy.writeQuery({ query: _graphql_Dealers_graphql__WEBPACK_IMPORTED_MODULE_15___default.a, data: data });
...
//# sourceMappingURL=index.26b1afa1014bd62ebbac.js.map