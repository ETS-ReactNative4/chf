...
var Products = function (_Component) {
  ...
  function Products(props) {
    ...
    _this.searchQuery = babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4___default()( /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.mark(function _callee() {
      var searchValue, _ref4, data, admin_products;
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _this.props.client.query({
                ...
                variables: { first: 50, query: '"' + searchValue + '"' }
              });
  ...
  babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_7___default()(Products, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (currSearch !== prevSearch && prevSearch.length == 0) {
...
//# sourceMappingURL=index.f4acd665a33d896d774a.js.map