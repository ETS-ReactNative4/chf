...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("axios");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var ramda__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("ramda");
/* harmony import */ var ramda__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(ramda__WEBPACK_IMPORTED_MODULE_12__);
...
/* harmony import */ var _graphql_S3Upload_graphql__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("../client/src/modules/admin/graphql/S3Upload.graphql");
/* harmony import */ var _graphql_S3Upload_graphql__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_graphql_S3Upload_graphql__WEBPACK_IMPORTED_MODULE_16__);
...
var Location = function (_React$Component) {
  babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_8___default()(Location, _React$Component);

  function Location(props) {
    var _this2 = this;

    babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_5___default()(this, Location);

    var _this = babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_7___default()(this, (Location.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_4___default()(Location)).call(this, props));
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_11___default.a.put(signedRequest, file, options);
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  image_data = new babel_runtime_core_js_map__WEBPACK_IMPORTED_MODULE_1___default.a();

                  getFileNameAndType = function getFileNameAndType(file) {
                    return Object(ramda__WEBPACK_IMPORTED_MODULE_12__["pick"])(['name', 'type'], file);
                  };
                  ...
                  if (files.length !== 0 && typeof files !== 'undefined') {
                    ...
                    Object(ramda__WEBPACK_IMPORTED_MODULE_12__["forEach"])(function () {
                    ...
                    }(), Object(ramda__WEBPACK_IMPORTED_MODULE_12__["values"])(files));
                  }
  ...
  babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_6___default()(Location, [{
    key: 'render',
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(
        ...
        this.props,
        react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(_components_Locations_LocationInfo__WEBPACK_IMPORTED_MODULE_17__["default"], babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({ adaptFileEventToValue: this.adaptFileEventToValue(uploadToS3) }, this.props)),
...
var LocationWithApollo = Object(react_apollo__WEBPACK_IMPORTED_MODULE_10__["compose"])(react_apollo__WEBPACK_IMPORTED_MODULE_10__["withApollo"],
// graphql(PAGES_QUERY, {
//   props: ({ data }) => {
...
//   })
// }),
Object(react_apollo__WEBPACK_IMPORTED_MODULE_10__["graphql"])(_graphql_DealerQuery_graphql__WEBPACK_IMPORTED_MODULE_14___default.a, {
...
//   }
// }),
Object(react_apollo__WEBPACK_IMPORTED_MODULE_10__["graphql"])(_graphql_Dealers_graphql__WEBPACK_IMPORTED_MODULE_13___default.a, {
...
}), Object(react_apollo__WEBPACK_IMPORTED_MODULE_10__["graphql"])(_graphql_UpdateDealer_graphql__WEBPACK_IMPORTED_MODULE_15___default.a, {
  props: function props(_ref8) {
    var mutate = _ref8.mutate;
    return {
      updateDealer: function () {
        var _ref9 = babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_3___default()( /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(function _callee5(dealer) {
  ...
  //   }
  // }
}), Object(react_apollo__WEBPACK_IMPORTED_MODULE_10__["graphql"])(_graphql_S3Upload_graphql__WEBPACK_IMPORTED_MODULE_16___default.a, {
  props: function props(_ref11) {
    var mutate = _ref11.mutate;
    return {
      signS3: function () {
        var _ref12 = babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_3___default()( /*#__PURE__*/babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(function _callee6(filename, filetype) {
          var response;
...
//# sourceMappingURL=index.eeeb4c7126a27a45cf0b.js.map