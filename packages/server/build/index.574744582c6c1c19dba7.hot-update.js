    ...
    update: function update(proxy, _ref12) {
      ...
      try {
        ...
        proxy.writeQuery({
          ...
          data: babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_3___default()({ dealers: { edges: [].concat(babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(data.dealers.edges), [{ node: updateDealer, cursor: 0 }]) } }, data)
        });
...
//# sourceMappingURL=index.bda49f250017c05643d3.js.map