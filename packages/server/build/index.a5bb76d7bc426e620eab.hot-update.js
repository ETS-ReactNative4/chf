  ...
  options: {
    update: function update(proxy, _ref12) {
      ...
      try {
        ...
        var _dealer = babel_runtime_core_js_object_assign__WEBPACK_IMPORTED_MODULE_0___default()({}, dealer.dealerByHandle, updateDealer);
        console.log('THE NEW _DEALER::', _dealer);
        proxy.writeQuery({
          query: _graphql_DealerQuery_graphql__WEBPACK_IMPORTED_MODULE_17___default.a,
          data: {
            dealerByHandle: _dealer
          },
          variables: { handle: _dealer.dealerByHandle.handle }
        });
...
//# sourceMappingURL=index.c4ebbcfd74c28c3a94ae.js.map